...
import ExternalLink from '@/app/pages/ExternalLink';
import Intro from '@/app/pages/Intro';
import TocAndLinks from '@/app/pages/TocAndLinks';
    ...
    <div className="aij-content">
      ...
      <ul>
        ...
        <li>
          ...
          le <span className="notion">r</span> ressemble beaucoup plus à un <span className="notion">l</span> français.
      ...
      <p>
        ...
        tracer <span className="notion">き</span> sans lever un minimum le pinceau (et qu’on est droitier), la plume va
        se retourner sur elle-même à l’endroit où à la main on laisse justement un espacement, et finalement former
      ...
      <p className="note">
        ...
        le <span className="notion">漢字</span> ou le <span className="notion">かな</span>, et d’autre part de comprendre
        et de retenir plus facilement les terminaisons des traits, et donc, de tracer plus facilement le caractère.
      </p>

      <p>
        Il existe des règles (et donc des exceptions) qui dictent comment tracer
        les <span className="notion">漢字</span> ou les <span className="notion">かな</span>. Voici les plus importantes,
      ...
      <ul>
        ...
        <li>
          ...
          et enfin <span className="notion">la partie droite</span> : par exemple <span className="notion">ふ</span>.
        </li>
      </ul>
      ...
      <p className="note">
        Vous remarquerez que <span className="notion">to</span> et <span className="notion">do</span> vous font faire la
        même forme dans votre bouche, seule "l’explosion" est différente.
      </p>
      ...
      <p>
        Une fois n’est pas coutume, <span className="notion">し</span>, <span className="notion">ち</span> et <span className="notion">つ</span> font exception :
      </p>
      ...
      <p>
        ...
        <br/>
        Pour les sons en <span className="notion">a</span>, on rajoute simplement un <span className="notion">あ</span>,
      ...
      <p>
        ...
        un <span className="notion">お</span> (comme dans <span className="place">おおさか</span> (oosaka) : la ville
        d’Osaka), et c’est la même pour les e-longs, parfois on les écrit en rajoutant
